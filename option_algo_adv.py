...
<title>{SYMBOL} — Supertrend + Options Report v4.3</title>
...
<body>
<header>
  <div class="logo">{SYMBOL} · Supertrend v4.3 · 5-Point Confirmation Entry</div>
...
<footer>
  {SYMBOL} Supertrend v4.3 — 5-Point Confirmation Entry &nbsp;·&nbsp;
...
def main():
    ...
    print(f"  NEW: 5-Point Confirmation Entry (±{ENTRY_CONFIRM_POINTS} pts)")
